...
import srts.Pvs;
import srts.Srts1Parallel;
import srts.Utils;

public class Srts1ParallelApp {
	...
	public static void main(String[] args) throws Exception {
		...
		String resultFile = currentPath + "srts1_result.csv";
		...
		Srts1Parallel srts1 = new Srts1Parallel();
		...
		if(commitAlgorithm == Srts1Parallel.COMMIT_HA_BASED)
		{
			writeLine(resultFile, numofSamples + ",HA_based," + tPriSign + "," + tPriVerify
					+ "," + tCheck + "\n");
		}
		else if(commitAlgorithm == Srts1Parallel.COMMIT_PE_BASED)
		{
